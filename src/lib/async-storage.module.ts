import { InjectionToken, ModuleWithProviders, NgModule, TypeProvider } from '@angular/core';
import { NGXS_PLUGINS } from '@ngxs/store';

import { NgxsAsyncStoragePlugin } from './async-storage.plugin';
import { NGXS_STORAGE_PLUGIN_OPTIONS, NgxsStoragePluginOptions, STORAGE_ENGINE } from './symbols';
